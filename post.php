<?php  include "includes/db.php"; ?>
 ...
 ?>
    ...
    if(isset($_SESSION['username']) && is_admin($_SESSION['username']) ) {
         ...
         $stmt1 = mysqli_prepare($connection, "SELECT post_title, post_author,post_user ,post_date, post_image, post_content FROM posts WHERE post_id = ?");


    } else {
        $stmt2 = mysqli_prepare($connection , "SELECT post_title, post_author, post_user,post_date, post_image, post_content FROM posts WHERE post_id = ? AND post_status = ? ");
